...
public class NotificationService {
    ...
    public void sendActivation(User user) throws ServiceException {
        ...
        model.put("discountHash", user.getAccountHash());
        model.put("domainString", domainResolver.getDomain());
        model.put("campaignName", WordUtils.capitalizeFully(user.getUsername()));
        ...
        try {
            ...
            sender.send("Уведомление о получении новой скидки", html, user.getUsername());
        } catch (Exception e) {
